...
// if(spmv_obj.name == "krnl_spmv_fast"){
//   std:: cout << "allocating buffer for fast computing" << std::endl;
// // memory allocation for fast kernel version
...
// if(spmv_obj.name == "krnl_spmv_reduced"){
//   std:: cout << "allocating buffer for reduced computing" << std::endl;
// // memory allocation for reduced kernel version
//   allocate_readonly_mem(cl_obj, (void **)&ptr_values, buf_idx++,
//                         num_values * sizeof(data_t));
